...
export interface TaskServiceClient {
  ...
  getAllTasks(request: Empty, metadata?: Metadata): Observable<TasksResponse>;

  completeTask(request: CompleteTaskRequest, metadata?: Metadata): Observable<Task>;
}
...
export interface TaskServiceController {
  ...
  getAllTasks(request: Empty, metadata?: Metadata): Promise<TasksResponse> | Observable<TasksResponse> | TasksResponse;

  completeTask(request: CompleteTaskRequest, metadata?: Metadata): Promise<Task> | Observable<Task> | Task;
}

export function TaskServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["createTask", "getAllTasks", "completeTask"];
...
export interface TaskServiceServer extends UntypedServiceImplementation {
  ...
  getAllTasks: handleUnaryCall<Empty, TasksResponse>;
  completeTask: handleUnaryCall<CompleteTaskRequest, Task>;
}
